{ ... }:
{
  ...
  home.file.".config/nvim/syntax/kickass.vim".text = /* vim */ ''
    ...
    " Attributed to:   Roman 'gryf' Dobosz <gryf_esm@o2.pl>
    "
    ...
    syn match kickAssMacroCall  "\<[a-z_][a-z0-9_]*\>("he=e-1
    syn case match
    ...
    if !exists("did_kickasm_syntax_inits")
      let did_kickasm_syntax_inits = 1
        ...
        hi def link kickAssLabel Label
